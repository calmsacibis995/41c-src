h09261
s 00418/00000/00000
d D 1.1 83/02/23 12:56:21 cooper 1 0
c date and time created 83/02/23 12:56:21 by cooper
e
u
U
t
...
\tswitch (p->designator) {\n";
		fprintf(cf1, format,
			pack_function(type->t_designator), ", flag");
		fprintf(cf2, format,
			unpack_function(type->t_designator), "");
